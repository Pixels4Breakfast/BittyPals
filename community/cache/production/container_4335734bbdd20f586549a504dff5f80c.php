...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000045ab65180000000070f441ba(
...
class phpbbtemplatetwiglexer_0000000045ab65180000000070f441ba extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5926620934e36731632591 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5926620934e46555260276 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5926620934e0c063638050 = array(
    ...
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, 'set_environment', array('env' => $env), $this->initializer5926620934e46555260276);

        return $this->valueHolder5926620934e36731632591->set_environment($env);
    }
    ...
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5926620934e46555260276);

        return $this->valueHolder5926620934e36731632591->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5926620934e46555260276);

        return $this->valueHolder5926620934e36731632591->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5926620934e46555260276 = $initializer;
    }
    ...
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, '__get', array('name' => $name), $this->initializer5926620934e46555260276);

        if (isset(self::$publicProperties5926620934e0c063638050[$name])) {
            return $this->valueHolder5926620934e36731632591->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5926620934e36731632591;
    ...
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5926620934e46555260276);
    ...
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, '__isset', array('name' => $name), $this->initializer5926620934e46555260276);
    ...
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, '__unset', array('name' => $name), $this->initializer5926620934e46555260276);
    ...
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, '__clone', array(), $this->initializer5926620934e46555260276);

        $this->valueHolder5926620934e36731632591 = clone $this->valueHolder5926620934e36731632591;
    }

    public function __sleep()
    {
        $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, '__sleep', array(), $this->initializer5926620934e46555260276);

        return array('valueHolder5926620934e36731632591');
    }
    ...
    {
        return $this->initializer5926620934e46555260276;
    }
    ...
    {
        return $this->initializer5926620934e46555260276 && $this->initializer5926620934e46555260276->__invoke($this->valueHolder5926620934e36731632591, $this, 'initializeProxy', array(), $this->initializer5926620934e46555260276);
    }
    ...
    {
        return null !== $this->valueHolder5926620934e36731632591;
    }
    ...
    {
        return $this->valueHolder5926620934e36731632591;
    }
