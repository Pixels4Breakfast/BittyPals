...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'phpbblh_oauth_tokens', 'phpbblh_oauth_states', 'phpbblh_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'phpbblh_users', $this, $this->get('dispatcher'), './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'phpbblh_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'phpbblh_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'phpbblh_forums', 'phpbblh_posts', 'phpbblh_topics', 'phpbblh_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbblh_captcha_questions', 'phpbblh_captcha_answers', 'phpbblh_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbblh_ext', './../', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'phpbblh_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbblh_migrations', './../', 'php', 'phpbblh_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './../', 'php', 'phpbblh_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbblh_modules', './../', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'phpbblh_notification_types', 'phpbblh_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbblh_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'phpbblh_notification_types', 'phpbblh_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'phpbblh_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'phpbblh_profile_fields', 'phpbblh_profile_lang', 'phpbblh_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004f63afaf0000000076cebaad(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'phpbblh_bbcodes', 'phpbblh_smilies', 'phpbblh_styles', 'phpbblh_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'phpbblh_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'phpbblh_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'phpbblh_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'phpbblh_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'phpbblh_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'phpbblh_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'phpbblh_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'phpbblh_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'phpbblh_acl_groups',
            'tables.acl_options' => 'phpbblh_acl_options',
            'tables.acl_roles' => 'phpbblh_acl_roles',
            'tables.acl_roles_data' => 'phpbblh_acl_roles_data',
            'tables.acl_users' => 'phpbblh_acl_users',
            'tables.attachments' => 'phpbblh_attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbblh_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbblh_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbblh_oauth_accounts',
            'tables.banlist' => 'phpbblh_banlist',
            'tables.bbcodes' => 'phpbblh_bbcodes',
            'tables.bookmarks' => 'phpbblh_bookmarks',
            'tables.bots' => 'phpbblh_bots',
            'tables.captcha_qa_questions' => 'phpbblh_captcha_questions',
            'tables.captcha_qa_answers' => 'phpbblh_captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbblh_qa_confirm',
            'tables.config' => 'phpbblh_config',
            'tables.config_text' => 'phpbblh_config_text',
            'tables.confirm' => 'phpbblh_confirm',
            'tables.disallow' => 'phpbblh_disallow',
            'tables.drafts' => 'phpbblh_drafts',
            'tables.ext' => 'phpbblh_ext',
            'tables.extensions' => 'phpbblh_extensions',
            'tables.extension_groups' => 'phpbblh_extension_groups',
            'tables.forums' => 'phpbblh_forums',
            'tables.forums_access' => 'phpbblh_forums_access',
            'tables.forums_track' => 'phpbblh_forums_track',
            'tables.forums_watch' => 'phpbblh_forums_watch',
            'tables.groups' => 'phpbblh_groups',
            'tables.icons' => 'phpbblh_icons',
            'tables.lang' => 'phpbblh_lang',
            'tables.log' => 'phpbblh_log',
            'tables.login_attempts' => 'phpbblh_login_attempts',
            'tables.migrations' => 'phpbblh_migrations',
            'tables.moderator_cache' => 'phpbblh_moderator_cache',
            'tables.modules' => 'phpbblh_modules',
            'tables.notification_types' => 'phpbblh_notification_types',
            'tables.notifications' => 'phpbblh_notifications',
            'tables.poll_options' => 'phpbblh_poll_options',
            'tables.poll_votes' => 'phpbblh_poll_votes',
            'tables.posts' => 'phpbblh_posts',
            'tables.privmsgs' => 'phpbblh_privmsgs',
            'tables.privmsgs_folder' => 'phpbblh_privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbblh_privmsgs_rules',
            'tables.privmsgs_to' => 'phpbblh_privmsgs_to',
            'tables.profile_fields' => 'phpbblh_profile_fields',
            'tables.profile_fields_data' => 'phpbblh_profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbblh_profile_fields_lang',
            'tables.profile_fields_language' => 'phpbblh_profile_lang',
            'tables.ranks' => 'phpbblh_ranks',
            'tables.reports' => 'phpbblh_reports',
            'tables.reports_reasons' => 'phpbblh_reports_reasons',
            'tables.search_results' => 'phpbblh_search_results',
            'tables.search_wordlist' => 'phpbblh_search_wordlist',
            'tables.search_wordmatch' => 'phpbblh_search_wordmatch',
            'tables.sessions' => 'phpbblh_sessions',
            'tables.sessions_keys' => 'phpbblh_sessions_keys',
            'tables.sitelist' => 'phpbblh_sitelist',
            'tables.smilies' => 'phpbblh_smilies',
            'tables.sphinx' => 'phpbblh_sphinx',
            'tables.styles' => 'phpbblh_styles',
            'tables.styles_template' => 'phpbblh_styles_template',
            'tables.styles_template_data' => 'phpbblh_styles_template_data',
            'tables.styles_theme' => 'phpbblh_styles_theme',
            'tables.styles_imageset' => 'phpbblh_styles_imageset',
            'tables.styles_imageset_data' => 'phpbblh_styles_imageset_data',
            'tables.teampage' => 'phpbblh_teampage',
            'tables.topics' => 'phpbblh_topics',
            'tables.topics_posted' => 'phpbblh_topics_posted',
            'tables.topics_track' => 'phpbblh_topics_track',
            'tables.topics_watch' => 'phpbblh_topics_watch',
            'tables.user_group' => 'phpbblh_user_group',
            'tables.user_notifications' => 'phpbblh_user_notifications',
            'tables.users' => 'phpbblh_users',
            'tables.warnings' => 'phpbblh_warnings',
            'tables.words' => 'phpbblh_words',
            'tables.zebra' => 'phpbblh_zebra',
...
class phpbbtemplatetwiglexer_000000004f63afaf0000000076cebaad extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder592664a2e436c717247629 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer592664a2e438b182340628 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties592664a2e4341029735293 = array(
    ...
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, 'set_environment', array('env' => $env), $this->initializer592664a2e438b182340628);

        return $this->valueHolder592664a2e436c717247629->set_environment($env);
    }
    ...
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer592664a2e438b182340628);

        return $this->valueHolder592664a2e436c717247629->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer592664a2e438b182340628);

        return $this->valueHolder592664a2e436c717247629->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer592664a2e438b182340628 = $initializer;
    }
    ...
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, '__get', array('name' => $name), $this->initializer592664a2e438b182340628);

        if (isset(self::$publicProperties592664a2e4341029735293[$name])) {
            return $this->valueHolder592664a2e436c717247629->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder592664a2e436c717247629;
    ...
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer592664a2e438b182340628);
    ...
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, '__isset', array('name' => $name), $this->initializer592664a2e438b182340628);
    ...
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, '__unset', array('name' => $name), $this->initializer592664a2e438b182340628);
    ...
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, '__clone', array(), $this->initializer592664a2e438b182340628);

        $this->valueHolder592664a2e436c717247629 = clone $this->valueHolder592664a2e436c717247629;
    }

    public function __sleep()
    {
        $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, '__sleep', array(), $this->initializer592664a2e438b182340628);

        return array('valueHolder592664a2e436c717247629');
    }
    ...
    {
        return $this->initializer592664a2e438b182340628;
    }
    ...
    {
        return $this->initializer592664a2e438b182340628 && $this->initializer592664a2e438b182340628->__invoke($this->valueHolder592664a2e436c717247629, $this, 'initializeProxy', array(), $this->initializer592664a2e438b182340628);
    }
    ...
    {
        return null !== $this->valueHolder592664a2e436c717247629;
    }
    ...
    {
        return $this->valueHolder592664a2e436c717247629;
    }
