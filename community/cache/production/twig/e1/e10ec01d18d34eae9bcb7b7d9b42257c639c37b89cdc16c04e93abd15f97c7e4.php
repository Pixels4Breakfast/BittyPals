...
class __TwigTemplate_99157e53f38f77041e09c55a1a35bfa8bf6f2cce4e08294039a02db57462cc4e extends Twig_Template
{
...
\t\t\tif (element.value && element.value != '";
            // line 97
            echo twig_escape_filter($this->env, $this->env->getExtension('phpbb')->lang("USER_ADMIN_BAN_NAME_REASON"), "js");
            echo "' && element.value != '";
            echo twig_escape_filter($this->env, $this->env->getExtension('phpbb')->lang("USER_ADMIN_BAN_EMAIL_REASON"), "js");
            echo "' && element.value != '";
            echo twig_escape_filter($this->env, $this->env->getExtension('phpbb')->lang("USER_ADMIN_BAN_IP_REASON"), "js");
            echo "')
\t\t\t{
\t\t\t\treturn;
\t\t\t}
