...
class __TwigTemplate_ede87974b2f08195db0d38f8c87c494cc256be5c7c6e2587ae31a1e7d8e343ae extends Twig_Template
{
...
\t<span class=\"right-box\"><a href=\"#review\" onclick=\"viewableArea(getElementById('topicreview'), true); var rev_text = getElementById('review').getElementsByTagName('a').item(0).firstChild; if (rev_text.data == '";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('phpbb')->lang("EXPAND_VIEW"), "js");
        echo "'){rev_text.data = '";
        echo twig_escape_filter($this->env, $this->env->getExtension('phpbb')->lang("COLLAPSE_VIEW"), "js");
...
\t\t\t\t\t<a href=\"#postingbox\" onclick=\"addquote(";
                    ...
                    echo "', '";
                    echo twig_escape_filter($this->env, $this->env->getExtension('phpbb')->lang("WROTE"), "js");
                    echo "', {post_id:";
                    echo $this->getAttribute($context["topic_review_row"], "POST_ID", array());
                    echo ",time:";
