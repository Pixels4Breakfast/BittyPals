          ...
          if (payment.state == 'approved') {
            ...
            swal({
              ...
              if (type == 'donation') {
                ...
                paramQuery({pid:playerID, mid:siteOptions.monthly_item*1, msrc:siteOptions.monthly_src}, validateMonthly, 'get_monthly_vars');
...
function validateMonthly(r) {
  console.warn("validateMonthly", r);
...
function logSerial(d) {
  paramQuery({s:d}, confirmCallback, 'log_serial');
  if (pp_env == 'sandbox') console.log(d);
}
