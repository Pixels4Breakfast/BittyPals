  ...
  var o = {
    ...
    start:function() {
      ...
      if (this.fullInit) {
        ...
        // this.sprite.animateSprite("play", this._animationOnInit);
    ...
    pause:function() {
      ...
      // this.sprite.animateSprite('frame', 1);
      this.frame(1);
    },
    setClass:function(c) {
      this._class = c;
    ...
    max:function(w, h) {
      ...
      // console.log("Sprite::max->pScale: ", pScale);
      var tScale = Math.floor(pScale * 100);
      while(tScale % 10 != 0) {
        tScale--;
      }
      pScale = tScale / 100;
      // console.log("Final scale for "+this.src+": ", pScale);
      // console.log("\tinitialW:  " + this.width + ", initialH:  " + this.height);
      // console.log("\tadjustedW: " + this.width * pScale + ", adjustedH: " + this.height * pScale);
